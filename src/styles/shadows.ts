...
export const SHADOW_1 = `0 0 2px ${COLOR_GRAY_2}`;
export const SHADOW_2 = `0 2px 4px ${COLOR_GRAY_2}`;
export const SHADOW_3 = `0 0 1px ${COLOR_GRAY_3}`;
export const SHADOW_4 = `0px 1px 2px ${COLOR_GRAY_2}`;
export const SHADOW_5 = `0 0 3px ${COLOR_GRAY_1}`;
export const SHADOW_6 = `0 2px 12px ${COLOR_GRAY_2}`;
